...
![overview](claypots-intro.png)

Color fonts are [not very widely supported](https://www.colorfonts.wtf) yet, but you can use Claypots to it’s full effect in both Illustrator and Photoshop, and as a traditional mono-color font in other software. I used the [Fontself Maker](https://www.fontself.com) plugin for Illustrator to author the font itself from the shapes I’d already drawn.
...
![xylophone](claypots-xylophone.png)

![claypots-museum](claypots-bizarre.png)

![claypots-museum](claypots-museum.png)

![claypots-going-out-black](claypots-going-out-black.png)
